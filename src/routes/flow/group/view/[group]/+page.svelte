...
<svelte:head>
    <title>{data.group.title} | When3meet</title>
</svelte:head>

<div class="container max-w-4xl xl:max-w-5xl mx-auto pt-10 p-3">
    <div class="flex justify-center">
        ...
        <div class="flex items-center justify-center" >
            ...
            <Button class="mr-2" on:click={() => {goto("/flow/meeting/new/" + data.group.id)}}>
            ...
            <Popover triggeredBy="#copy-btn" trigger="click" offset="10" placement="bottom" transition={fade} params={{duration: 100}}>
                Link copied!
            </Popover>
        </div>
    </div>
    ...
    <div class="grid grid-cols-auto-fill gap-2 max-w-full">
        {#each data.group.expand.members as m (m.id)}
            <Member member={m} organizer={data.group.organizers.includes(m.id)} author={data.group.author === m.id}>
                <div slot="right">
                    {#if m.id !== data.user?.id && m.id !== data.group.author && (data.user?.id === data.group.author || data.group.organizers.includes(data.user?.id))}
