<script lang="ts">
	...
	function copyLink() {
		navigator.clipboard.writeText(
			$page.url.protocol + '//' + $page.url.host + '/flow/group/join/' + data.group.id
		);
	}
		...
		<div class="flex flex-col items-center justify-center py-10">
			...
			<div class="w-96 md:w-1/2 py-6 max-w-full">
				<svg
					...
					><circle cx="406.69135" cy="6.46689" r="6.46689" fill="#f2f2f2" /><circle
						cx="406.69135"
						cy="32.24019"
						r="6.46689"
						fill="#f2f2f2"
					/><circle cx="433.69135" cy="6.46689" r="6.46689" fill="#f2f2f2" /><circle
						cx="433.69135"
						cy="32.24019"
						r="6.46689"
						fill="#f2f2f2"
					/><circle cx="460.69135" cy="6.46689" r="6.46689" fill="#f2f2f2" /><circle
						cx="460.69135"
						cy="32.24019"
						r="6.46689"
						fill="#f2f2f2"
					/><circle cx="460.69135" cy="58.01349" r="6.46689" fill="#f2f2f2" /><circle
						cx="460.69135"
						cy="83.7868"
						r="6.46689"
						fill="#f2f2f2"
					/><circle cx="487.69135" cy="6.46689" r="6.46689" fill="#f2f2f2" /><circle
						cx="487.69135"
						cy="32.24019"
						r="6.46689"
						fill="#f2f2f2"
					/><circle cx="487.69135" cy="58.01349" r="6.46689" fill="#f2f2f2" /><circle
						cx="487.69135"
						cy="83.7868"
						r="6.46689"
						fill="#f2f2f2"
					/><circle cx="514.69135" cy="6.46689" r="6.46689" fill="#f2f2f2" /><circle
						cx="514.69135"
						cy="32.24019"
						r="6.46689"
						fill="#f2f2f2"
					/><circle cx="541.69135" cy="6.46689" r="6.46689" fill="#f2f2f2" /><circle
						cx="541.69135"
						cy="32.24019"
						r="6.46689"
						fill="#f2f2f2"
					/><path
						...
						fill="#3f3d56"
					/><rect x="688.10933" y="367.76179" width="13" height="84" fill="#3f3d56" /><path
					...
					/><path
						...
						transform="translate(-206.08631 -223.44402)"
						fill="#6c63ff"
					/><circle cx="697.75644" cy="207.24158" r="24.56103" fill="#ffb8b8" /><path
					...
					/><path
						...
						transform="translate(-206.08631 -223.44402)"
						fill="#3f3d56"
					/><circle cx="632.79741" cy="302.22257" r="6" fill="#6c63ff" /><path
					...
					/><path
						...
						transform="translate(-206.08631 -223.44402)"
						fill="#ccc"
					/><circle cx="94.87339" cy="208.00327" r="24.56103" fill="#a0616a" /><path
			...
			{#each data.meetings as meeting (meeting.id)}
				<Card padding="none" class="p-4" href={'/flow/meeting/view/' + meeting.id}>
					<div class="p-4">
						...
						<div>
							{new Date(Date.parse(meeting.created)).toLocaleDateString('en-us', {
								weekday: 'long',
								year: 'numeric',
								month: 'short',
								day: 'numeric'
					...
					{#if m.id !== data.user?.id && m.id !== data.group.author && (data.user?.id === data.group.author || data.group.organizers.includes(data.user?.id))}
						...
						<Dropdown placement="right">
							{#if data.group.organizers.includes(m.id)}
								<DropdownItem
									on:click={() => {
										removeOrganizer(m.id);
									}}>Remove Organizer</DropdownItem
								>
							{:else}
								<DropdownItem
									on:click={() => {
										makeOrganizer(m.id);
									}}>Make Organizer</DropdownItem
								>
							{/if}
							<DropdownItem
								slot="footer"
